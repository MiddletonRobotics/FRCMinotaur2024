...
public class SwerveController extends Command {
    ...
    public void execute() {
        ...
        swerveSubsystem.drive(new Translation2d(translationValue, strafeValue).times(Constants.SwerveConstants.PhysicalMaxSpeedMetersPerSecond), rotationValue * Constants.SwerveConstants.PhysicalAngularMaxVelocity, true);
    }
}