...
public class Constants {
    public static final class ModuleConstants {
        ...
        public static final ModuleConfiguration MK3_FAST = new ModuleConfiguration(
            (48.0 / 16.0) * (16.0 / 28.0) * (60.0 / 15.0), // (16.0 / 48.0) * (28.0 / 16.0) * (15.0 / 60.0)
            (32.0 / 15.0) * (60.0 / 10.0) // (15.0 / 32.0) * (10.0 / 60.0)
        );
    ...
    public static final class SwerveConstants {
        ...
        public static final double DriveGearRatio = ModuleConstants.MK3_FAST.getDriveReduction(); // Our MK3 modules are configured with the fast gear ratio (6.86:1)
        public static final double AngleGearRatio = ModuleConstants.MK3_FAST.getSteerReduction(); // Steering ratio on the MK3 modules is 12.8:1
