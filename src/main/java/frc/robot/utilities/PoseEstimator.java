...
public class PoseEstimator extends SubsystemBase {
    ...
    public void periodic() {
        ...
        drivetrain.resetSwerveOdometry(getPosition());
        }
        ...
        drivetrain.resetSwerveOdometry(new Pose2d(xAvg, yAvg, drivetrain.getHeading()));
    ...
    public void updateOdometryEstimate() {
        poseEstimator.update(drivetrain.getHeading(), drivetrain.getSwerveModulePositions());
    }
    ...
    public void resetPoseEstimate(Pose2d poseMeters) {
        drivetrain.resetSwerveOdometry(poseMeters);
        poseEstimator.resetPosition(drivetrain.getHeading(), drivetrain.getSwerveModulePositions(), drivetrain.getPose());
        
    }

    public void resetHeading(Rotation2d angle) {
        drivetrain.resetSwerveOdometry(new Pose2d(drivetrain.getPose().getTranslation(), angle));
